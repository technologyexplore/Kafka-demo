...
public class KafkaConsumerDemo1 extends Thread {
    ...
    public KafkaConsumerDemo1(String topic) {
        ...
        properties.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG,
                "192.168.139.128:9092,192.168.139.130:9092,192.168.139.131:9092");
    ...
    public void run() {
        ...
        while (true) {
            ...
            for (ConsumerRecord consumerRecord : consumerRecords) {
                System.out.println("patition: " + consumerRecord.partition() + "-> message recive: " + consumerRecord.value());
            }
        }
    ...
    public static void main(String[] args) {
        ...
        new KafkaConsumerDemo1("test200").start();
    }
}
